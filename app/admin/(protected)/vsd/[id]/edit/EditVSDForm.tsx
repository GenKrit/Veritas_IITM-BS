// // app/admin/(protected)/vsd/[id]/edit/EditVSDForm.tsx
// "use client";
...
// export default function EditVSDForm({ digest }: { digest: any }) {
//   const router = useRouter();
//   const [form, setForm] = useState({
//     title: digest.title,
//     description: digest.description || "",
//     volume: String(digest.volume),
//     issue: String(digest.issue),
//     month: digest.month,
//     link: digest.link,
//   });
...
//     try {
//       const res = await fetch(`/api/admin/vsd/${digest.id}`, {
//         method: "PATCH",
...
//           </Link>
//           <h1 className="text-3xl font-bold">Edit Digest</h1>
//           <p className="text-gray-400">Update the digest information below</p>
//         </div>
...
//               onClick={submit}
//               disabled={loading}
//               className="flex-1 bg-white text-black px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
//             >
...
//             <button
//               onClick={() => router.back()}
//               className="flex-1 border border-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors"
//             >
//               Cancel
//             </button>
//           </div>
    ...
    <div className="min-h-screen bg-neutral-200">
      <div className="px-6 lg:px-8 py-8">
        ...
        <div className="bg-linear-to-br from-neutral-800 to-neutral-900 rounded-xl p-8 mb-8 shadow-lg">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Edit Digest</h1>
          <p className="text-neutral-300">Update the digest information below</p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <FormField label="Title" required>
                  <input
                    ...
                    value={form.title}
                    onChange={(e) => setForm({ ...form, title: e.target.value })}
                    className="w-full p-3 bg-white border-2 border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-neutral-900 placeholder:text-neutral-400 outline-none"
                  />
                </FormField>
                ...
                <FormField label="Description">
                  <textarea
                    ...
                    onChange={(e) => setForm({ ...form, description: e.target.value })}
                    rows={4}
                    className="w-full p-3 bg-white border-2 border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-y text-neutral-900 placeholder:text-neutral-400 outline-none"
                  />
                </FormField>
              </div>
